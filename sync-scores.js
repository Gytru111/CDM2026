...
async function fetchESPN() {
  ...
  // STATUS_FULL_TIME = fin du temps réglementaire (90 min) — c'est le seul
  // statut utilisé pour les scores des pronostics. STATUS_FINAL est
  // EXCLU volontairement : ESPN l'utilise après prolongation/TAB, ce qui
  // donnerait un score gonflé (ex: 3-2 après prolongation au lieu de 2-2
  // à 90 min). Pour les phases à élimination directe, seul le résultat à
  // 90 minutes compte pour départager les pronostics.
